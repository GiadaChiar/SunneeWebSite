...
export declare function handleAdd(addButton: HTMLButtonElement | null, ctx: any, productsCart: any[], allProducts: BaseProduct[]): void;
export declare function handleLess(lessButton: HTMLButtonElement | null, ctx: any, productsCart: any[], allProducts: BaseProduct[]): void;
export declare function handleDelete(deleteButton: HTMLButtonElement | null, ctx: any, productsCart: any[], userLogId: string): void;
